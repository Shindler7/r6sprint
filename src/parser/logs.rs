...
mod tests {
    ...
    fn test_log_kind() {
        ...
        assert_eq!(LogKind::parser().parse(r#"App::Journal RegisterAsset {"asset_id": "bayc", "liquidity": 100000000, "user_id": "Steeve",}"#), Ok(("", LogKind::App(Box::from(AppLogKind::Journal(AppLogJournalKind::RegisterAsset { asset_id: "bayc".into(), user_id: "Steeve".into(), liquidity: 100_000_000 }))))));
        assert_eq!(
            LogKind::parser()
        ...
        assert_eq!(LogKind::parser().parse(r#"App::Journal BuyAsset UserBacket{"user_id": "Steeve", "backet": Backet{"asset_id":"bayc","count":1,},}"#), Ok(("", LogKind::App(Box::from(AppLogKind::Journal(AppLogJournalKind::BuyAsset(UserBacket { user_id: "Steeve".into(), backet: Backet { asset_id: "bayc".into(), count: 1 } })))))));
    }
}
